...
%         'IncludeSubfolders', true, 'LabelSource', 'foldernames');
    ...
    fprintf('%3d\t\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%3d\t|%4.2f\t\t|%4.2f\t\t|%4.2f\t\t|\n',...
            itrNumb, P(1), P(2), P(3), P(4), P(5), P(6), P(7), P(8), ...
            P(9), P(10), P(11), P(12), P(13), acc, sec, - prf)
    
    optimizationResults = [optimizationResults; {itrNumb, P(1), P(2), ...
        P(3), P(4), P(5), P(6), P(7), P(8), P(9), P(10), P(11), P(12), P(13), acc, sec, - prf}];
