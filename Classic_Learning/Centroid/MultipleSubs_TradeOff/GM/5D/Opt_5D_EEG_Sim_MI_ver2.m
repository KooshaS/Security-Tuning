...
%         if ((feature(1,1,j) - muhat_sub1_trn1)^2 + (feature(1,2,j) - muhat_sub1_trn2)^2 + (feature(1,3,j) - muhat_sub1_trn3)^2 + (feature(1,4,j) - muhat_sub1_trn4)^2 + (feature(1,5,j) - muhat_sub1_trn5)^2) >= thr^2
    ...
    %         if ((feature(2,1,j) - muhat_sub1_trn1)^2 + (feature(2,2,j) - muhat_sub1_trn2)^2 + (feature(2,3,j) - muhat_sub1_trn3)^2 + (feature(2,4,j) - muhat_sub1_trn4)^2 + (feature(2,5,j) - muhat_sub1_trn5)^2) < thr^2
            ...
            cond_x1 = (feature(k,1,j) < muhat_sub1_trn1 + threshold) && (feature(k,1,j) > muhat_sub1_trn1 - threshold);
            cond_x2 = (feature(k,2,j) < muhat_sub1_trn2 + threshold) && (feature(k,2,j) > muhat_sub1_trn2 - threshold);
            cond_x3 = (feature(k,3,j) < muhat_sub1_trn3 + threshold) && (feature(k,3,j) > muhat_sub1_trn3 - threshold);
            cond_x4 = (feature(k,4,j) < muhat_sub1_trn4 + threshold) && (feature(k,4,j) > muhat_sub1_trn4 - threshold);
            cond_x5 = (feature(k,5,j) < muhat_sub1_trn5 + threshold) && (feature(k,5,j) > muhat_sub1_trn5 - threshold);        
