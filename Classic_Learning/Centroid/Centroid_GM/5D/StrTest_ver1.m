...
%     thr = thr + 3*mean([sigmahat_sub1_trn1 sigmahat_sub1_trn2])/changing_seed;
    thr = thr + 5*max([sigmahat_w_1 sigmahat_w_2])/changing_seed; 
...
%     security_bits_t(1, i) = log2(10*sigmahat_w_1*10*sigmahat_w_2*10*sigmahat_w_3*10*sigmahat_w_4*10*sigmahat_w_5/(2*thr)^5);
     security_bits_t(1, i) = log2((10*max([sigmahat_w_1 sigmahat_w_2]))^2/(2*thr)^2);
...
thr = thr + 49*5*max([sigmahat_w_1 sigmahat_w_2])/changing_seed;
changing_seed = 1000;
for i = 50:changing_seed
...
% thr = thr + 3*mean([sigmahat_sub1_trn1 sigmahat_sub1_trn2])/changing_seed;
    ...
    for j = 1:100
        j
        rx1 = muhat_w_1 - 5*max([sigmahat_w_1 sigmahat_w_2]) + (10*max([sigmahat_w_1 sigmahat_w_2])).*rand;
        rx2 = muhat_w_2 - 5*max([sigmahat_w_1 sigmahat_w_2]) + (10*max([sigmahat_w_1 sigmahat_w_2])).*rand;
