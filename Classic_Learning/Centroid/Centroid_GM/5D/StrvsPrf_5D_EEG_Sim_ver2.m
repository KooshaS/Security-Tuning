...
%     thr = thr + 3*max([sigmahat_sub1_trn1 sigmahat_sub1_trn2 sigmahat_sub1_trn3 sigmahat_sub1_trn4 sigmahat_sub1_trn5])/changing_seed; 
    for j = 181:239
%         if ((feature(1,1,j) - muhat_sub1_trn1)^2 + (feature(1,2,j) - muhat_sub1_trn2)^2 + (feature(1,3,j) - muhat_sub1_trn3)^2 + (feature(1,4,j) - muhat_sub1_trn4)^2 + (feature(1,5,j) - muhat_sub1_trn5)^2) >= thr^2
...
%         if ((feature(2,1,j) - muhat_sub1_trn1)^2 + (feature(2,2,j) - muhat_sub1_trn2)^2 + (feature(2,3,j) - muhat_sub1_trn3)^2 + (feature(2,4,j) - muhat_sub1_trn4)^2 + (feature(2,5,j) - muhat_sub1_trn5)^2) < thr^2

        cond_x1 = (feature(2,1,j) < muhat_sub1_trn1 + thr) && (feature(2,1,j) > muhat_sub1_trn1 - thr);
        cond_x2 = (feature(2,2,j) < muhat_sub1_trn2 + thr) && (feature(2,2,j) > muhat_sub1_trn2 - thr);
        cond_x3 = (feature(2,3,j) < muhat_sub1_trn3 + thr) && (feature(2,3,j) > muhat_sub1_trn3 - thr);
        cond_x4 = (feature(2,4,j) < muhat_sub1_trn4 + thr) && (feature(2,4,j) > muhat_sub1_trn4 - thr);
        cond_x5 = (feature(2,5,j) < muhat_sub1_trn5 + thr) && (feature(2,5,j) > muhat_sub1_trn5 - thr);        
...
thr = 0;
thr = thr + 199*5*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5])/changing_seed;
% thr = 99*nthroot((15/(8*pi^2))*(10*sigmahat_w_1*10*sigmahat_w_2*10*sigmahat_w_3*10*sigmahat_w_4*10*sigmahat_w_5),5)/changing_seed;
% thr = 99*3*max([sigmahat_sub1_trn1 sigmahat_sub1_trn2 sigmahat_sub1_trn3 sigmahat_sub1_trn4 sigmahat_sub1_trn5])/changing_seed;
changing_seed = 1000;
...
%     thr = thr + nthroot((15/(8*pi^2))*(10*sigmahat_w_1*10*sigmahat_w_2*10*sigmahat_w_3*10*sigmahat_w_4*10*sigmahat_w_5),5)/changing_seed;
    ...
    for j = 1:100
        j
        rx1 = muhat_w_1 - 5*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5]) + (10*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5])).*rand;
        rx2 = muhat_w_2 - 5*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5]) + (10*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5])).*rand;
        rx3 = muhat_w_3 - 5*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5]) + (10*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5])).*rand;
        rx4 = muhat_w_4 - 5*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5]) + (10*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5])).*rand;
        rx5 = muhat_w_5 - 5*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5]) + (10*max([sigmahat_w_1 sigmahat_w_2 sigmahat_w_3 sigmahat_w_4 sigmahat_w_5])).*rand;        
