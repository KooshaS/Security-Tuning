...
GMModel_sub1_tst = fitgmdist(reshape(feature(1, :, 181:239), [2, 59])',2,'Options',options);
% hold on
% h = ezcontour(gmPDF,[0 1000],[0 600]);
% title('Scatter Plot and PDF Contour')
% hold off

GMModel_sub2_tst = fitgmdist(reshape(feature(2, :, 181:239), [2, 59])',2,'Options',options);
% hold on
% h = ezcontour(gmPDF,[0 1000],[0 600]);
% title('Scatter Plot and PDF Contour')
% hold off
